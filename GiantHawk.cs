...
namespace RPGlibrary {
    public class GiantHawk:Hawk {
        public GiantHawk() {
        }
        public GiantHawk(int playerLevel) {
            ...
            while (this.Level != enemyLevel) {
                ...
                this.MaxHitPoints = this.MaxHitPoints + (int)Math.Ceiling((double)this.MaxHitPoints * ((double)random.Next(12, 25) / 100));
